...
public class CoordinateSystem {
    ...
    private int currentColor, currentStrokeColor;
    ...
    private void renderShape() {
        float deltaTop = axisLength * 0.05f;

        Cylinder pillar = new Cylinder(PARENT_APP);
        pillar.bodyColor = this.currentColor;
        pillar.strokeColor = this.currentStrokeColor;
        ...
        top.bodyColor = this.currentColor;
        top.strokeColor = this.currentStrokeColor;
    ...
    public void render() {
        ...
        PARENT_APP.box(this.axisThickness * 2.5f);
        //X-axis
        PARENT_APP.pushMatrix();
        this.currentColor = this.colorX;
        this.currentStrokeColor = this.strokeColorX;
        PARENT_APP.rotateY(PApplet.radians(90));
        renderShape();
        PARENT_APP.popMatrix();
        //Y-axis
        PARENT_APP.pushMatrix();
        this.currentColor = this.colorY;
        this.currentStrokeColor = this.strokeColorY;
        ...
        if (dimension == Dimension.D3D) {
            PARENT_APP.pushMatrix();
            this.currentColor = this.colorZ;
            this.currentStrokeColor = this.strokeColorZ;
            renderShape();
            PARENT_APP.popMatrix();
        }
        PARENT_APP.popMatrix();
