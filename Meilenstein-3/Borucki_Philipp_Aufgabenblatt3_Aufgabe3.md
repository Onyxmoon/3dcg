...
$$
\vec{v_s}  = \vec{v} \cdot s \space\space\space\space\space\space\space\space\space\space\space \space \left\{s \in  \mathbb{R} \space \and \space \vec{v} \in \mathbb{R}^n \space |\space n \in \mathbb{N} \right\}
$$
...
$$
\vec{ps} = \vec{u} + \vec{v} \cdot (s \cdot 2) \space\space\space\space\space\space\space\space\space \text{wobei: } \vec{u} := \text{Ursprung} \space\and \vec{v} := \text{Richtung} \space\and s := \text{Sekunden}
$$
